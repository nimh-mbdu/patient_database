...
# 
# Participant <- c("RNGT") # enter the initials of the participant you want to produce a summary report for
...
start <- data %>% filter(Clinical_Visit_Number==1) %>% select(Clinical_Visit_Date) %>% pull()
...
`r head(data$FIRST_NAME,1)` `r head(data$LAST_NAME,1)`  

**Treatment dates:**

Began: `r start`  
Finished: `r tail(data$Clinical_Visit_Date, 1)`

***

Dear `r head(data$FIRST_NAME,1)`,  

Congratulations on successfully completing the 13-session course of Behavioral Activation with the Mood Brain & Development Unit at the National Institute of Mental Health! Through your hard work and effort you have helped to advance the brain science that will help other teenagers in the future. Thank you!  
...
It has been a true pleasure to get to know you and to work with you over these 13 weeks. I wish you all the best!  
