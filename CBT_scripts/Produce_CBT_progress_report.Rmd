...
data %>% filter(!is.na(s_mfq1w_tot) | !is.na(p_f_mfq1w_tot) | !is.na(p_m_mfq1w_tot)) %>%  filter(Clinical_Visit_Number != '0') %>%
  arrange(Clinical_Visit_Number) %>% select(Clinical_Visit_Date3, Clinical_Visit_Number, s_mfq1w_tot, p_f_mfq1w_tot, p_m_mfq1w_tot) %>%
  mutate(s_mfq1w_tot = replace_na(s_mfq1w_tot, " ")) %>% mutate(p_f_mfq1w_tot = replace_na(p_f_mfq1w_tot, " ")) %>% mutate(p_m_mfq1w_tot = replace_na(p_m_mfq1w_tot, " ")) %>%
...
data %>% filter(!is.na(s_scared_tot) | !is.na(p_f_scared_tot) | !is.na(p_m_scared_tot)) %>%  filter(Clinical_Visit_Number != '0') %>%
  arrange(Clinical_Visit_Number) %>% select(Clinical_Visit_Date3, Clinical_Visit_Number, s_scared_tot, p_f_scared_tot, p_m_scared_tot) %>%
  mutate(s_scared_tot = replace_na(s_scared_tot, " ")) %>% mutate(p_f_scared_tot = replace_na(p_f_scared_tot, " ")) %>% mutate(p_m_scared_tot = replace_na(p_m_scared_tot, " ")) %>%
  kable(., col.names = c("Visit Date", "Visit Number", "Child reporting on self", "Father reporting on child", "Mother reporting on child"))
...
data %>% filter(!is.na(s_ari1w_tot) | !is.na(p_f_ari1w_tot) | !is.na(p_m_ari1w_tot)) %>% filter(Clinical_Visit_Number != '0') %>%
  arrange(Clinical_Visit_Number) %>% select(Clinical_Visit_Date3, Clinical_Visit_Number, s_ari1w_tot, p_f_ari1w_tot, p_m_ari1w_tot) %>%
  mutate(s_ari1w_tot = replace_na(s_ari1w_tot, " ")) %>% mutate(p_f_ari1w_tot = replace_na(p_f_ari1w_tot, " ")) %>% mutate(p_m_ari1w_tot = replace_na(p_m_ari1w_tot, " ")) %>%
  kable(., col.names = c("Visit Date", "Visit Number", "Child reporting on self", "Father reporting on child", "Mother reporting on child"))
