...
data %>% filter(!is.na(s_mfq1w_tot) | !is.na(p_mfq1w_tot)) %>% 
...
data %>% filter(!is.na(s_scared_tot) | !is.na(p_scared_tot)) %>% 
...
data %>% filter(!is.na(s_ari1w_tot) | !is.na(p_ari1w_tot)) %>% 
