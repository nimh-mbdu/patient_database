...
# rm(s_crisis_3m, s_crisis_baseline, s_crisis_followup, p_crisis_3m, p_crisis_baseline, p_crisis_followup)
...
# 
# # combine these
# crisis_table <- tibble(Respondant=c("Parent", "Child"), CRISIS_Completed=c(parent_completed_crisis_base, child_completed_crisis_base), 
...
# crisis_table %>% kable(., col.names = c("Respondant", "Total Contacted", "Total Agreed to Participate", "%", "Completed all Psych", "%", "Completed CRISIS", "%")) %>% 
#   kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
