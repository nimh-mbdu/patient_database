...
all_table <- tibble(Respondant=c("Parent", "Child"), 
  ...
  mutate(All_fu_percent = (ALL_fu_completed/Tot_agreed)*100) %>% mutate(All_fu2_percent = (ALL_fu2_completed/Tot_agreed)*100) %>% 
  mutate(All_both_percent = (ALL_both_completed/Tot_agreed)*100) %>% mutate(All_both2_percent = (ALL_both2_completed/Tot_agreed)*100) %>%
  ...
  select(Respondant, Tot_contacted, Tot_agreed, Agreed_percent, ALL_base_completed, All_base_percent, ALL_fu_completed, All_fu_percent, 
         ALL_fu2_completed, All_fu2_percent, ALL_both_completed, All_both_percent, ALL_both2_completed, All_both2_percent)
...
crisis_table <- tibble(Respondant=c("Parent", "Child"), 
  ...
  select(Respondant, Tot_contacted, Tot_agreed, Agreed_percent, CRISIS_base_completed, CRISIS_base_percent, CRISIS_fu_completed, CRISIS_fu_percent, 
         CRISIS_fu2_completed, CRISIS_fu2_percent, CRISIS_both_completed, CRISIS_both_percent, CRISIS_both2_completed, CRISIS_both2_percent)
...
all_table %>% kable(., col.names = c("Respondant", "Total Contacted", "Total Agreed to Participate", "%", 
                                     "Completed all Psych: baseline", "%", "Completed all Psych: follow up 1", "%", "Completed all Psych: follow up 2", "%", 
                                     "Completed all Psych: baseline & follow up 1", "%", "Completed all Psych: baseline & follow ups 1 & 2", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
...
crisis_table %>% kable(., col.names = c("Respondant", "Total Contacted", "Total Agreed to Participate", "%", 
                                     "Completed CRISIS: baseline", "%", "Completed CRISIS: follow up 1", "%", "Completed CRISIS: follow up 2", "%",
                                     "Completed CRISIS: baseline & follow up 1", "%", "Completed CRISIS: baseline & follow ups 1 & 2", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
...
MMI_recovery_table_Dx <- rbind(MMI_recovery_table_Dx, MMI_totals)
...
MMI_recovery_table_Dx %>% kable(., col.names = c("Diagnosis", "Number of times completed", "Freq", "Total")) %>%
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
