...
if (exists("Psychometrics_treatment")==FALSE) {
        ...
        Psychometrics_date <- c(master_database_combined$Date)
        family_hist <- Psychometrics_treatment %>% 
          select(Initials, IRTA_tracker, Participant_Type2, Clinical_Visit_Date, Clinical_Visit_Type, c_family_interview_date, c_family_interview_interviewer) %>% 
...
Numbers as of last database update (`r Psychometrics_date`). 
