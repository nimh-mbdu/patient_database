...
screens_table2 %>% kable(., col.names = c("Eligibility", "HV", "MDD",  "UNSURE", "Total", "NA")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
...
protocol_0037_characterization_table3 <- left_join(protocol_0037_characterization_table2, order) %>% arrange(Order) %>% select(-Order)

protocol_0037_characterization_table3$Eligible <- recode(protocol_0037_characterization_table3$Eligible,
  "0"="1a. Include",
  "1"="1b. Include: can’t scan (braces, etc.)",
  "2"="2a. On hold: contact again after specified amount of time",
  "3"="2b. On hold: low priority",
  "4"="3a. Excluded: cannot be reached or scheduled, all contact options exhausted",
  "5"="3b. Excluded: does not meet criteria",
  "6"="3c. Excluded: meets exclusionary criteria (substance use, psychosis, etc.)",
  "7"="4. Withdrawn: did not or withdrew assent/consent",
