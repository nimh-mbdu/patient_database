...
date_temp <- c((todays_date_formatted + 30), (todays_date_formatted + 190), (todays_date_formatted + 274), (todays_date_formatted + 365)) %>% 
  as.tibble() %>% rename(Date = value) %>% mutate(Status=c(3, 4, 5, 6))
...
rm(baseline, baseline_removed, removed_initials, FU_completed, one_year, two_year, baseline_keep, temp1, temp2, rest_temp, date_temp, descrip_table)
