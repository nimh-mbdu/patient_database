...
all_table <- tibble(Respondant=c("Parent", "Child"), 
  ...
  select(Respondant, Tot_contacted, Tot_agreed, Agreed_percent, ALL_base_completed, All_base_percent, 
    ALL_fu_completed, All_fu_percent, ALL_fu2_completed, All_fu2_percent, ALL_fu3_completed, All_fu3_percent, 
    ALL_both_completed, All_both_percent, ALL_both2_completed, All_both2_percent, ALL_both3_completed, All_both3_percent)
...
crisis_table <- tibble(Respondant=c("Parent", "Child"), 
  ...
  select(Respondant, Tot_contacted, Tot_agreed, Agreed_percent, CRISIS_base_completed, CRISIS_base_percent, CRISIS_fu_completed, CRISIS_fu_percent, 
         CRISIS_fu2_completed, CRISIS_fu2_percent, CRISIS_fu3_completed, CRISIS_fu3_percent, CRISIS_both_completed, CRISIS_both_percent, 
    CRISIS_both2_completed, CRISIS_both2_percent, CRISIS_both3_completed, CRISIS_both3_percent)
...
all_table %>% select(-Tot_contacted:-Agreed_percent) %>% 
  kable(., col.names = c("Respondant", "Completed baseline", "%", "Completed follow up 1", "%", "Completed follow up 2", "%", "Completed follow up 3", "%", 
                        "Completed baseline & follow up 1", "%", "Completed baseline & follow ups 1 & 2", "%", "Completed baseline & follow ups 1, 2 & 3", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
...
crisis_table %>% select(-Tot_contacted:-Agreed_percent) %>% 
  kable(., col.names = c("Respondant", "Completed CRISIS: baseline", "%", "Completed CRISIS: follow up 1", "%", "Completed CRISIS: follow up 2", "%",
    "Completed CRISIS: follow up 3", "%", "Completed CRISIS: baseline & follow up 1", "%", "Completed CRISIS: baseline & follow ups 1 & 2", "%",
    "Completed CRISIS: baseline & follow ups 1, 2 & 3", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
