...
all_table %>% # select(-Tot_contacted:-Agreed_percent) %>% 
  ...
  kable(., col.names = c("Respondant", "Total agreed", "Completed baseline", "%", "Completed 1 follow up ", "%", "Completed 2 follow ups ", "%", 
    "Completed 3 follow ups", "%", "Completed 4 follow ups", "%", "Completed 5 follow ups", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
...
all_table %>% # select(-Tot_contacted:-Agreed_percent) %>% 
  ...
  kable(., col.names = c("Respondant", "Total agreed", "Completed baseline & 1 follow up", "%", "Completed baseline & 2 follow ups", "%", 
    "Completed baseline & 3 follow ups", "%", "Completed baseline & 4 follow ups", "%","Completed baseline & 5 follow ups", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
...
crisis_table %>% # select(-Tot_contacted:-Agreed_percent) %>% 
  ...
  kable(., col.names = c("Respondant", "Total agreed", "Completed CRISIS: baseline", "%", "Completed CRISIS: 1 follow up", "%", "Completed CRISIS: 2 follow ups", "%",
    "Completed CRISIS: 3 follow ups", "%", "Completed CRISIS: 4 follow ups", "%", "Completed CRISIS: 5 follow ups", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
...
crisis_table %>% # select(-Tot_contacted:-Agreed_percent) %>% 
  ...
  kable(., col.names = c("Respondant", "Total agreed", "Completed CRISIS: baseline & 1 follow up", "%", "Completed CRISIS: baseline & 2 follow ups", "%",
    "Completed CRISIS: baseline & 3 follow ups", "%", "Completed CRISIS: baseline & 4 follow ups", "%", "Completed CRISIS: baseline & 5 follow ups", "%")) %>% 
  kable_styling(position = "left", bootstrap_options = c("striped", "hover", "condensed"))
