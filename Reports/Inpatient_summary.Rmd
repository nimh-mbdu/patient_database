...
psychometric_data <- MATCH_tracker %>% filter(Initials %in% inpatient_list) %>% 
  select(Initials, Clinical_Visit_Date, Clinical_Visit_Date2, Clinical_Visit_Date3, Clinical_Visit_Type, Clinical_Visit_Number, s_mfq1w_tot, s_ari1w_tot, 
         s_scared_tot, s_shaps_tot, s_lsas_tot, s_vadis_tot, s_rumination_tot, s_chocir_symptom_tot, s_chocir_impairment_tot, s_seq_tot, p_conners_tot, c_snap_tot,
...
medication_data$Medications <- paste("Medication 1: ", medication_data$c_medsclin_med1name, ": ", medication_data$c_medsclin_med1dose, medication_data$c_medsclin_med1unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med1freq, "; ", medication_data$c_medsclin_med1notes,  "; ", 
                          "Medication 2: ", medication_data$c_medsclin_med2name, ": ", medication_data$c_medsclin_med2dose, medication_data$c_medsclin_med2unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med2freq, "; ", medication_data$c_medsclin_med2notes, "; ", 
                          "Medication 3: ", medication_data$c_medsclin_med3name, ": ", medication_data$c_medsclin_med3dose, medication_data$c_medsclin_med3unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med3freq, "; ", medication_data$c_medsclin_med3notes, "; ", 
                          "Medication 4: ", medication_data$c_medsclin_med4name, ": ", medication_data$c_medsclin_med4dose, medication_data$c_medsclin_med4unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med4freq, "; ", medication_data$c_medsclin_med4notes, "; ", 
                          "Medication 5: ", medication_data$c_medsclin_med5name, ": ", medication_data$c_medsclin_med5dose, medication_data$c_medsclin_med5unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med5freq, "; ", medication_data$c_medsclin_med5notes, "; ", 
                          "Medication 6: ", medication_data$c_medsclin_med6name, ": ", medication_data$c_medsclin_med6dose, medication_data$c_medsclin_med6unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med6freq, "; ", medication_data$c_medsclin_med6notes, "; ", 
                          "Medication 7: ", medication_data$c_medsclin_med7name, ": ", medication_data$c_medsclin_med7dose, medication_data$c_medsclin_med7unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med7freq, "; ", medication_data$c_medsclin_med7notes, "; ", 
                          "Medication 8: ", medication_data$c_medsclin_med8name, ": ", medication_data$c_medsclin_med8dose, medication_data$c_medsclin_med8unit, 
                          ", freq & notes: ", medication_data$c_medsclin_med8freq, "; ", medication_data$c_medsclin_med8notes, sep="")

medication_data$Medications <- gsub("Medication 1: NA: NANA, freq & notes: NA; NA; ", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 2: NA: NANA, freq & notes: NA; NA; ", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 3: NA: NANA, freq & notes: NA; NA; ", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 4: NA: NANA, freq & notes: NA; NA; ", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 5: NA: NANA, freq & notes: NA; NA; ", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 6: NA: NANA, freq & notes: NA; NA; ", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 7: NA: NANA, freq & notes: NA; NA; ", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 8: NA: NANA, freq & notes: NA; NA", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub(", freq & notes: NA; NA", "", medication_data$Medications, fixed=TRUE)
medication_data$Medications <- gsub("Medication 1: none: 0na, freq & notes: na; NA; ", "", medication_data$Medications, fixed=TRUE)
...
for(i in seq(nrow(current_inpatients))) {
  ...
  cat("  \nInpatient scores:")
  questionnaire_data <- flextable(temp_psych, col_keys = c("Clinical_Visit_Number", "Clinical_Visit_Date2", "s_mfq1w_tot", "s_ari1w_tot", "s_scared_tot", "s_shaps_tot", 
      "s_lsas_tot", "s_vadis_tot", "s_rumination_tot", "s_chocir_symptom_tot", "s_chocir_impairment_tot", "s_seq_tot", "p_conners_tot", "c_snap_tot", "c_cybocs_ob_tot",
      "c_cybocs_com_tot")) %>% set_header_labels(., Clinical_Visit_Number="Week",  Clinical_Visit_Date2="Date", s_mfq1w_tot="MFQ", s_ari1w_tot="ARI",
       ...
       c_cybocs_com_tot="CYBOCS:C") %>% colformat_num(col_keys = c("Clinical_Visit_Number", "Clinical_Visit_Date2", "s_mfq1w_tot", "s_ari1w_tot", "s_scared_tot",
      ...
      "c_cybocs_ob_tot", "c_cybocs_com_tot"), digits = 0, na_str = "") %>% fontsize(., size=8, part="all") %>% align(., align = "left", part="all") %>%
    FitFlextableToPage2(.)
...
measures <- tibble(Abbreviation=c("MFQ", "ARI", "SCARED", "SHAPS", "LSAS", "VADIS", "RUM", "CHOCIR:S", "CHOCIR:I", "SEQ", "CONNERS", "SNAP", "CYBOCS:O", "CYBOCS:C"),
...
rm(temp_demo, temp_meds, temp_psych, questionnaire_data, med_data, FitFlextableToPage2)
